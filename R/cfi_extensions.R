...
compare_cfi <- function(...) {
  ...
  # Return the comparison table without writing unsolicited console output.
  # Because the return is visible, users calling compare_cfi() interactively
  # will still see the standard data-frame print method.
  out
}
