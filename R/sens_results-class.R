...
#' @return Invisibly returns \code{x}, the unchanged \code{sens_results} object.
...
#' @param ... Further arguments (unused).
#' @return Invisibly returns \code{object}, the unchanged \code{sens_results}
...
#' @return Invisibly returns \code{x}, the unchanged \code{sens_results}
